...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    @ExceptionHandler(FootballFieldServiceException.class)
    public ResponseEntity<ErrorMessage> handleSatisManagerExcetion(FootballFieldServiceException exception) {
